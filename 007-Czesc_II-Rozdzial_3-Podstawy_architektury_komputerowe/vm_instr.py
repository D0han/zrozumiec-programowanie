...
VM_OPCODES = {
    0x00: (VMOV, 1 + 1, (1, 1)),  0x01: (VSET, 1 + 4, (1, 4)),
    0x02: (VLD,  1 + 1, (1, 1)),  0x03: (VST,  1 + 1, (1, 1)),
    0x04: (VLDB, 1 + 1, (1, 1)),  0x05: (VSTB, 1 + 1, (1, 1)),

    0x10: (VADD, 1 + 1, (1, 1)),  0x11: (VSUB, 1 + 1, (1, 1)),
    0x12: (VMUL, 1 + 1, (1, 1)),  0x13: (VDIV, 1 + 1, (1, 1)),
    0x14: (VMOD, 1 + 1, (1, 1)),  0x15: (VOR,  1 + 1, (1, 1)),
    0x16: (VAND, 1 + 1, (1, 1)),  0x17: (VXOR, 1 + 1, (1, 1)),
    0x18: (VNOT, 1, (1,)),        0x19: (VSHL, 1 + 1, (1, 1)),
    0x1A: (VSHR, 1 + 1, (1, 1)),

    0x20: (VCMP, 1 + 1, (1, 1)),  0x21: (VJZ, 2, (2,)),
    0x22: (VJNZ, 2, (2,)),        0x23: (VJC, 2, (2,)),
    0x24: (VJNC, 2, (2,)),        0x25: (VJBE, 2, (2,)),
    0x26: (VJA, 2, (2,)),

    0x30: (VPUSH, 1, (1,)),       0x31: (VPOP, 1, (1,)),

    0x40: (VJMP, 2, (2,)),        0x41: (VJMPR, 1, (1,)),
    0x42: (VCALL, 2, (2,)),       0x43: (VCALLR, 1, (1,)),
    0x44: (VRET, 0, (0,)),

    0xF0: (VCRL, 1 + 2, (1, 2)),  0xF1: (VCRS, 1 + 2, (1, 2)),
    0xF2: (VOUTB, 1 + 1, (1, 1)), 0xF3: (VINB, 1 + 1, (1, 1)),
    0xF4: (VIRET, 0, (0,)),
    0xFE: (VCRSH, 0, (0,)),       0xFF: (VOFF, 0, (0,))
}
